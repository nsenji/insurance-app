...
class _GadgetState extends State<Gadget> {
  ...
  final TextEditingController _gadgetType = TextEditingController();
  final TextEditingController _gadgetName = TextEditingController();
  final TextEditingController _imei = TextEditingController();
  final TextEditingController _datePurchased = TextEditingController();
              ...
              Padding(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                      // errorText: codeIsEmpty ? 'This field is required' : null,
                      label: MajorFont(
                    text: 'Picture of device and receipt',
                    weight: false,
                    size: 15,
                  )
                      //hintText: 'username',
